...
public class CalendarListCaActivity extends AppCompatActivity {
    ...
    private static String CalURL = "http://159.89.193.200//getcallist_ca.php";
    private static String CalTAG = "getcal";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_calendarlist_ca);
        ...
        ibtn_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, CalendarView.class);
        ...
        ibtn_calenderlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, CalendarListActivity.class);
                startActivity(intent);
            }
        });
        ...
        ibtn_tracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, DayTrackerActivity.class);
                startActivity(intent);
            }
        });
        ibtn_store.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent=new Intent(CalendarListCaActivity.this, Store_main.class);
                startActivity(intent);
            }
        });
        ...
        btn_todolist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, TodoListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btn_habitlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, HabitListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btn_ddaylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, DDayListActivity.class);
                startActivity(intent);
                finish();
            }
        });
        ...
        btn_importancealign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this, CalendarListImActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btn_categoryalign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this,CalendarListCaActivity.class);
                startActivity(intent);
                finish();
            }
        });
        btn_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListCaActivity.this,SearchActivity.class);
                intent.putExtra("search",et_search.getText().toString());
                startActivity(intent);
                finish();
            }
        });
        String email = PreferenceManager.getString(CalendarListCaActivity.this, "email");
        ...
        CalendarListCaActivity.GetData caltask = new CalendarListCaActivity.GetData(); //밑에 만들었던 클래스 만들고
        ...
        calendarListAdapter.setOnCheckedChangeListener(new CalendarListAdapter.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked, int pos) {
                ...
                RequestQueue queue= Volley.newRequestQueue(CalendarListCaActivity.this);
    ...
    private class GetData extends AsyncTask<String, Void, String> { //php읽어서 디비에서 데이터 가져오는 전체 프로세스를 클래스로 생성
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(CalendarListCaActivity.this,
    ...
    public void calclick(){
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(CalendarListCaActivity.this);
