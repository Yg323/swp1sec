...
public class p_r_PopupActivity extends AppCompatActivity {
    ...
    private static String IP_ADDRESS = "159.89.193.200/p_r_store.php";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String data = "팔레트 랜덤 상자를 구매하시겠습니까?";
        Log.d(TAG, "data= " + data);
        ...
        okBtn.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                if(mnum <70){
                    Toast.makeText(getApplicationContext(), "일반 색상팔레트 1을 획득하셨습니다!", Toast.LENGTH_SHORT).show();
                    //Snackbar.make(v, "일반 테마", Snackbar.LENGTH_SHORT).show();
                }else{
                    Toast.makeText(getApplicationContext(), "프리미엄 색상팔레트 1을 획득하셨습니다!", Toast.LENGTH_SHORT).show();
...
/*
            ...
            Intent intent = getIntent();
            //Log.d(TAG, "intent= " + intent);
            String data = "색상 팔레트 랜덤 박스를 구매하시겠습니까?";
            //Log.d(TAG, "data= " + data);
            txtText.setText(data);
        }
    }
