...
public class CalendarViewM extends FrameLayout {
    ...
    private final int[] weekHeaderIds = {
            com.example.swp1sec.R.id.tv_weekday_1, com.example.swp1sec.R.id.tv_weekday_2, com.example.swp1sec.R.id.tv_weekday_3, com.example.swp1sec.R.id.tv_weekday_4,
            com.example.swp1sec.R.id.tv_weekday_5, com.example.swp1sec.R.id.tv_weekday_6, com.example.swp1sec.R.id.tv_weekday_7
    };
    ...
    private void readAttributes(Context context, AttributeSet attrs) {
        ...
        int colorPrimary = getThemeColor(context, com.example.swp1sec.R.attr.colorPrimary);

        TypedArray a = context.obtainStyledAttributes(attrs, com.example.swp1sec.R.styleable.CalendarViewM, 0, 0);

        mAttributes.put(Attr.contentBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_content_background_color, Color.TRANSPARENT));

        // Month
        mAttributes.put(Attr.monthHeaderTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_month_header_text_color, colorPrimary));
        mAttributes.put(Attr.monthHeaderBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_month_header_background_color, Color.TRANSPARENT));
        mAttributes.put(Attr.monthHeaderArrowsColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_month_header_arrows_color, colorPrimary));
        mAttributes.put(Attr.monthHeaderShow,
                a.getBoolean(com.example.swp1sec.R.styleable.CalendarViewM_month_header_show, true)? 1 : 0);

        // WeekHeader
        mAttributes.put(Attr.weekHeaderTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_week_header_text_color, Color.WHITE));
        mAttributes.put(Attr.weekHeaderBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_week_header_background_color, colorPrimary));
        mAttributes.put(Attr.weekHeaderOffsetDayTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_week_header_offset_day_text_color, Color.RED)); //일요일은 red로(위쪽 sunday를 말함)
        mAttributes.put(Attr.weekHeaderOffsetDayBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_week_header_offset_day_background_color,
                        mAttributes.get(Attr.weekHeaderBackgroundColor)));
        mAttributes.put(Attr.weekHeaderMovable,
                a.getBoolean(com.example.swp1sec.R.styleable.CalendarViewM_week_header_movable, true)? 1 : 0);

        // Day Item
        mAttributes.put(Attr.dayTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_day_text_color, colorPrimary));
        mAttributes.put(Attr.dayBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_day_background_color, Color.TRANSPARENT));

        // OffsetDay
        mAttributes.put(Attr.offsetDayTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_offset_day_text_color, Color.RED)); // 일요일인 날짜를 red로
        mAttributes.put(Attr.offsetDayBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_offset_day_background_color,
                        mAttributes.get(Attr.dayBackgroundColor)));

        // Current Day
        mAttributes.put(Attr.currentDayTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_current_day_text_color, colorPrimary));
        mAttributes.put(Attr.currentDayBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_current_day_background_color, Color.TRANSPARENT));
        mAttributes.put(Attr.currentDayTextStyle,
                a.getInt(com.example.swp1sec.R.styleable.CalendarViewM_current_day_text_style, Typeface.BOLD));  // BOLD 캘린더 텍스트 볼드체
        mAttributes.put(Attr.currentDayCircleEnable,
                a.getBoolean(com.example.swp1sec.R.styleable.CalendarViewM_current_day_circle_enable, false)? 1 : 0);
        mAttributes.put(Attr.currentDayCircleColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_current_day_circle_color,
                        mAttributes.get(Attr.currentDayTextColor)));



        //주 시작요일 설정
        int s = PreferenceManager.getInt(context,"start_week");
        ...
        mAttributes.put(Attr.selectedDayTextColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_selected_day_text_color, mAttributes.get(Attr.dayTextColor)));
        mAttributes.put(Attr.selectedDayBackgroundColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_selected_day_background_color, Color.TRANSPARENT));
        mAttributes.put(Attr.selectedDayBorderColor,
                a.getColor(com.example.swp1sec.R.styleable.CalendarViewM_selected_day_border_color, colorPrimary));

        mAttributes.put(Attr.dayOffset,
                a.getInt(com.example.swp1sec.R.styleable.CalendarViewM_offset_day, Calendar.SUNDAY)); // Sunday 아래 요일 빨간색 표시

        mAttributes.put(Attr.startingWeekDay,
                a.getInt(com.example.swp1sec.R.styleable.CalendarViewM_starting_weekday, c)); // 일주일의 시작 요일 설정 Calendar.MONDAY
    ...
    private void initChildViews(Context context) {
        ...
        inflater.inflate(com.example.swp1sec.R.layout.xml_calendar_view, this, true);

        mViewPager = findViewById(com.example.swp1sec.R.id.view_pager);
        ...
        mViewPager.addOnPageChangeListener(new ViewPager.SimpleOnPageChangeListener() {
            ...
            public void onPageSelected(int position) {
                if (mPageListener != null) {
                    ...
                    mPageListener.onMonthChanged(ymdCalendar.month, ymdCalendar.year); //여기에 ymdCalendar.day를 추가
                }
            }
        });
        ...
        ivPrevious = findViewById(com.example.swp1sec.R.id.ib_previous_month); //이전 달 달력 표시
        ...
        ivNext = findViewById(com.example.swp1sec.R.id.ib_next_month); //다음 달 달력 표시
    ...
    private void setMonthHeader(View view, Calendar month) {
        TextView tvMonth = view.findViewById(com.example.swp1sec.R.id.tv_month);
...
//View에서 설정한 각각의 칸을 불러옴
        private final int[] dayViewIDs = new int[] {
                com.example.swp1sec.R.id.day_item_1_1, com.example.swp1sec.R.id.day_item_1_2, com.example.swp1sec.R.id.day_item_1_3, com.example.swp1sec.R.id.day_item_1_4,
                com.example.swp1sec.R.id.day_item_1_5, com.example.swp1sec.R.id.day_item_1_6, com.example.swp1sec.R.id.day_item_1_7,

                com.example.swp1sec.R.id.day_item_2_1, com.example.swp1sec.R.id.day_item_2_2, com.example.swp1sec.R.id.day_item_2_3, com.example.swp1sec.R.id.day_item_2_4,
                com.example.swp1sec.R.id.day_item_2_5, com.example.swp1sec.R.id.day_item_2_6, com.example.swp1sec.R.id.day_item_2_7,

                com.example.swp1sec.R.id.day_item_3_1, com.example.swp1sec.R.id.day_item_3_2, com.example.swp1sec.R.id.day_item_3_3, com.example.swp1sec.R.id.day_item_3_4,
                com.example.swp1sec.R.id.day_item_3_5, com.example.swp1sec.R.id.day_item_3_6, com.example.swp1sec.R.id.day_item_3_7,

                com.example.swp1sec.R.id.day_item_4_1, com.example.swp1sec.R.id.day_item_4_2, com.example.swp1sec.R.id.day_item_4_3, com.example.swp1sec.R.id.day_item_4_4,
                com.example.swp1sec.R.id.day_item_4_5, com.example.swp1sec.R.id.day_item_4_6, com.example.swp1sec.R.id.day_item_4_7,

                com.example.swp1sec.R.id.day_item_5_1, com.example.swp1sec.R.id.day_item_5_2, com.example.swp1sec.R.id.day_item_5_3, com.example.swp1sec.R.id.day_item_5_4,
                com.example.swp1sec.R.id.day_item_5_5, com.example.swp1sec.R.id.day_item_5_6, com.example.swp1sec.R.id.day_item_5_7,

                com.example.swp1sec.R.id.day_item_6_1, com.example.swp1sec.R.id.day_item_6_2, com.example.swp1sec.R.id.day_item_6_3, com.example.swp1sec.R.id.day_item_6_4,
                com.example.swp1sec.R.id.day_item_6_5, com.example.swp1sec.R.id.day_item_6_6, com.example.swp1sec.R.id.day_item_6_7
        };
        ...
        public Object instantiateItem(@NonNull ViewGroup container, int position) {
            ...
            View monthContainer = vi.inflate(com.example.swp1sec.R.layout.xml_calendar_container, container, false);
        ...
        private void setMonthView(View view, final Calendar month) {
            view.findViewById(com.example.swp1sec.R.id.ll_calendar_container)
        ...
        private void onBindView(int position,
            ...
            SelectedTextView tvDay = view.findViewById(com.example.swp1sec.R.id.tv_calendar_day); //일표시(동그라미 안에 숫자)
            //MultipleTriangleView vNotes = view.findViewById(R.id.v_notes); //일 아래 내용 표시
            LinearLayout vNotes = view.findViewById(com.example.swp1sec.R.id.v_notes);//추가
            ...
            for (CalendarObject c : calendarObjectList) {
                ...
                TextView textView = (TextView) LayoutInflater.from(getContext()).inflate(com.example.swp1sec.R.layout.xml_textview,null);
    ...
    public interface OnMonthChangedListener {
        void onMonthChanged(int month, int year); // 여기에 int day를 추가했음
    }
