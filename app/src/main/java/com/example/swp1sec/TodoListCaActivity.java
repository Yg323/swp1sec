...
public class TodoListCaActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtn_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(TodoListCaActivity.this, CalendarView.class);
        ...
        ibtn_tracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListCaActivity.this, DayTrackerActivity.class);
                startActivity(intent);
            }
        });
        /*ibtn_store.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent=new Intent(TodoListCaActivity.this, StoreActivity.class);
                startActivity(intent);
            }
        });*/
        ...
        TodoListCaActivity.GetData caltask = new TodoListCaActivity.GetData(); //밑에 만들었던 클래스 만들고
    ...
    private class GetData extends AsyncTask<String, Void, String> { //php읽어서 디비에서 데이터 가져오는 전체 프로세스를 클래스로 생성
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(TodoListCaActivity.this,
    ...
    public void calclick(){
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(TodoListCaActivity.this);
