...
public class TodoListImActivity extends AppCompatActivity {
    ...
    private static String URL = "http://159.89.193.200//gettodolist_im.php";
    private static String TAG = "gettodo";

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_todolist_im);
        ...
        ibtn_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, CalendarView.class);
        ...
        ibtn_calenderlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, CalendarListActivity.class);
                startActivity(intent);
            }
        });
        ...
        ibtn_tracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, DayTrackerActivity.class);
                startActivity(intent);
            }
        });
        ibtn_store.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent=new Intent(TodoListImActivity.this, Store_main.class);
                startActivity(intent);
            }
        });
        ...
        btn_todolist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, TodoListActivity.class);
                startActivity(intent);
            }
        });
        btn_habitlist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, HabitListActivity.class);
                startActivity(intent);
            }
        });
        btn_ddaylist.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, DDayListActivity.class);
                startActivity(intent);
            }
        });
        ...
        btn_importancealign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this, TodoListImActivity.class);
                startActivity(intent);
            }
        });
        btn_categoryalign.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this,TodoListCaActivity.class);
                startActivity(intent);
            }
        });
        btn_search.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(TodoListImActivity.this,SearchActivity.class);
                intent.putExtra("search",et_search.getText().toString());
                startActivity(intent);
            }
        });
        String email = PreferenceManager.getString(TodoListImActivity.this, "email");
        ...
        TodoListImActivity.GetData caltask = new TodoListImActivity.GetData(); //밑에 만들었던 클래스 만들고
        ...
        todoListAdapter.setOnCheckedChangeListener(new TodoListAdapter.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked, int pos) {
                ...
                RequestQueue queue= Volley.newRequestQueue(TodoListImActivity.this);
    ...
    private class GetData extends AsyncTask<String, Void, String> { //php읽어서 디비에서 데이터 가져오는 전체 프로세스를 클래스로 생성
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(TodoListImActivity.this,
    ...
    public void calclick(){
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(TodoListImActivity.this);
