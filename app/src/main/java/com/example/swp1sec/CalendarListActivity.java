...
public class CalendarListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ibtn_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(CalendarListActivity.this, CalendarView.class);
        ...
        ibtn_tracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(CalendarListActivity.this, DayTrackerActivity.class);
                startActivity(intent);
            }
        });
        ibtn_store.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent=new Intent(CalendarListActivity.this, Store_main.class);
                startActivity(intent);
            }
        });
        ...
        CalendarListActivity.GetData caltask = new CalendarListActivity.GetData(); //밑에 만들었던 클래스 만들고
    ...
    private class GetData extends AsyncTask<String, Void, String> { //php읽어서 디비에서 데이터 가져오는 전체 프로세스를 클래스로 생성
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(CalendarListActivity.this,
    ...
    public void calclick(){
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(CalendarListActivity.this);
