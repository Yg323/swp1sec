...
public class DDayListPActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ddaylist_p);
        ...
        ibtn_calender.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                intent = new Intent(DDayListPActivity.this, CalendarView.class);
        ...
        ibtn_tracker.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                intent = new Intent(DDayListPActivity.this, DayTrackerActivity.class);
                startActivity(intent);
            }
        });
        ...
        DDayListPActivity.GetData task = new DDayListPActivity.GetData(); //밑에 만들었던 클래스 만들고
        task.execute(URL, email,cal_title); //task 실행
    ...
    private class GetData extends AsyncTask<String, Void, String> { //php읽어서 디비에서 데이터 가져오는 전체 프로세스를 클래스로 생성
        ...
        protected void onPreExecute() {
            super.onPreExecute();
            progressDialog = ProgressDialog.show(DDayListPActivity.this,
    ...
    public void calclick(){
        ...
        AlertDialog.Builder dlg = new AlertDialog.Builder(DDayListPActivity.this);
